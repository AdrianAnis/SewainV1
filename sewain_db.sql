...
(30, 1, 'LOGIN', '2026-06-24 02:48:38', 'ANS berhasil login sebagai owner'),
(31, 1, 'LOGIN', '2026-06-24 03:08:53', 'ANS berhasil login sebagai owner'),
(32, 23, 'LOGIN', '2026-06-24 06:05:35', 'Admin SewaIn berhasil login sebagai admin'),
(33, 25, 'LOGIN', '2026-06-24 06:10:54', 'MBG Wowo berhasil login sebagai tenant'),
(34, 23, 'LOGIN', '2026-06-24 06:23:33', 'Admin SewaIn berhasil login sebagai admin'),
(35, 25, 'LOGOUT', '2026-06-24 06:46:56', 'MBG Wowo logout dari sistem'),
(36, NULL, 'LOGIN_FAILED', '2026-06-24 06:47:03', 'Percobaan login gagal untuk email: admin'),
(37, 23, 'LOGIN', '2026-06-24 06:47:11', 'Admin SewaIn berhasil login sebagai admin'),
(38, 23, 'LOGIN', '2026-06-24 07:02:36', 'Admin SewaIn berhasil login sebagai admin'),
(39, 23, 'LOGOUT', '2026-06-24 07:03:41', 'Admin SewaIn logout dari sistem'),
(40, NULL, 'REGISTER', '2026-06-24 07:06:36', 'adriananispratama berhasil mendaftar akun baru sebagai Tenant'),
(41, 35, 'LOGIN', '2026-06-24 07:07:15', 'adriananispratama berhasil login sebagai tenant'),
(42, 23, 'LOGIN', '2026-06-24 07:09:26', 'Admin SewaIn berhasil login sebagai admin'),
(43, 23, 'REJECT_OWNER_REQUEST', '2026-06-24 07:09:40', 'Admin SewaIn menolak permintaan Owner dari: adriananispratama'),
(44, 23, 'APPROVE_OWNER_REQUEST', '2026-06-24 07:10:07', 'Admin SewaIn menyetujui permintaan Owner dari: adriananispratama'),
(45, 35, 'ADD_PROPERTY', '2026-06-24 07:12:14', 'Owner adriananispratama menambahkan properti baru: Nael Tampubulon Mahersa'),
(46, 35, 'EDIT_PROPERTY', '2026-06-24 07:12:34', 'Owner adriananispratama mengedit properti: Nael Tampubulon Edit (ID: 36)'),
(47, 35, 'DELETE_PROPERTY', '2026-06-24 07:13:07', 'Owner adriananispratama menghapus properti: Nael Tampubulon Edit (ID: 36)'),
(48, 35, 'ADD_PROPERTY', '2026-06-24 07:14:16', 'Owner adriananispratama menambahkan properti baru: Bismilllah'),
(49, 23, 'VERIFY PROPERTY', '2026-06-24 07:15:02', 'Admin SewaIn menolak properti: Bismilllah (ID: 37) karena: Data kurang lengkap'),
(50, 35, 'DELETE_PROPERTY', '2026-06-24 07:15:41', 'Owner adriananispratama menghapus properti: Bismilllah (ID: 37)'),
(51, 35, 'ADD_PROPERTY', '2026-06-24 07:25:17', 'Owner adriananispratama menambahkan properti baru: a'),
(52, 23, 'VERIFY PROPERTY', '2026-06-24 07:25:40', 'Admin SewaIn menyetujui properti: a (ID: 38)'),
(53, 35, 'SUBMIT_REPORT', '2026-06-24 07:29:36', 'Tenant adriananispratama mengirim laporan untuk properti ID: 38'),
(54, 23, 'FLAG PROPERTY', '2026-06-24 07:29:59', 'Admin SewaIn menandai (flagged) properti: a (ID: 38) karena: E emang penipu'),
(55, 23, 'UNFLAG PROPERTY', '2026-06-24 07:30:40', 'Admin SewaIn mencabut flag pada properti: a (ID: 38)'),
(56, 35, 'SUBMIT_REPORT', '2026-06-24 07:34:05', 'Tenant adriananispratama mengirim laporan untuk properti ID: 38'),
(57, 23, 'FLAG PROPERTY', '2026-06-24 07:34:24', 'Admin SewaIn menandai (flagged) properti: a (ID: 38) karena: OKE'),
(58, 23, 'LOGIN', '2026-06-24 07:38:33', 'Admin SewaIn berhasil login sebagai admin'),
(59, 23, 'LOGIN', '2026-06-24 07:39:36', 'Admin SewaIn berhasil login sebagai admin'),
(60, 23, 'LOGIN', '2026-06-24 07:40:54', 'Admin SewaIn berhasil login sebagai admin'),
(61, 23, 'LOGIN', '2026-06-24 07:43:41', 'Admin SewaIn berhasil login sebagai admin'),
(62, 35, 'LOGIN', '2026-06-24 07:44:46', 'adriananispratama berhasil login sebagai owner'),
(63, 35, 'SUBMIT_REPORT', '2026-06-24 07:45:57', 'Tenant adriananispratama mengirim laporan untuk properti ID: 38'),
(64, 23, 'FLAG PROPERTY', '2026-06-24 07:46:13', 'Admin SewaIn menandai (flagged) properti: a (ID: 38) karena: 2'),
(65, 35, 'SUBMIT_REPORT', '2026-06-24 07:46:27', 'Tenant adriananispratama mengirim laporan untuk properti ID: 38'),
(66, 23, 'FLAG PROPERTY', '2026-06-24 07:46:42', 'Admin SewaIn menandai (flagged) properti: a (ID: 38) karena: 3'),
(67, 23, 'LOGIN', '2026-06-24 07:50:26', 'Admin SewaIn berhasil login sebagai admin'),
(68, 23, 'LOGIN', '2026-06-24 07:51:49', 'Admin SewaIn berhasil login sebagai admin'),
(69, 23, 'DELETE PROPERTY', '2026-06-24 07:53:02', 'Admin SewaIn menghapus properti secara permanen: a (ID: 38)'),
(70, 23, 'DELETE PROPERTY', '2026-06-24 07:53:52', 'Admin SewaIn menghapus properti secara permanen: Kost Putri Muslimah Syariah (ID: 10)'),
(71, 32, 'LOGIN', '2026-06-24 07:54:45', 'Tenant berhasil login sebagai tenant'),
(72, NULL, 'REGISTER', '2026-06-24 08:52:54', 'Bayu berhasil mendaftar akun baru sebagai Tenant'),
(73, 36, 'LOGIN', '2026-06-24 08:53:17', 'Bayu berhasil login sebagai tenant'),
(74, 23, 'LOGIN', '2026-06-24 08:53:53', 'Admin SewaIn berhasil login sebagai admin'),
(75, 36, 'SUBMIT_REPORT', '2026-06-24 08:54:56', 'Tenant Bayu mengirim laporan untuk properti ID: 9'),
(76, 23, 'APPROVE_OWNER_REQUEST', '2026-06-24 08:56:33', 'Admin SewaIn menyetujui permintaan Owner dari: MBG Wowo'),
(77, 23, 'FLAG PROPERTY', '2026-06-24 08:56:51', 'Admin SewaIn menandai (flagged) properti: Kost Sage Green Exclusive Men (ID: 9) karena: Beneran Jelek, Ga layak pake'),
(78, 23, 'RESOLVE REPORT', '2026-06-24 08:56:59', 'Admin SewaIn menyelesaikan laporan ID: 10'),
(79, 23, 'UNFLAG PROPERTY', '2026-06-24 08:57:30', 'Admin SewaIn mencabut flag pada properti: Kost Sage Green Exclusive Men (ID: 9)'),
(80, 23, 'APPROVE_OWNER_REQUEST', '2026-06-24 08:59:54', 'Admin SewaIn menyetujui permintaan Owner dari: Bayu'),
(81, 36, 'ADD_PROPERTY', '2026-06-24 09:01:28', 'Owner Bayu menambahkan properti baru: TEST'),
(82, 23, 'LOGIN', '2026-06-24 12:12:36', 'Admin SewaIn berhasil login sebagai admin');
...
(11, 35, 'rejected', '2026-06-24 14:09:10', 'Mau aja', 'https://res.cloudinary.com/dxffgd86l/image/upload/v1782284949/sewain/57828655-f62f-4ffc-a5fb-326971ebaa4e.jpg', 'Lu gk valaid'),
(12, 35, 'approved', '2026-06-24 14:09:59', 'MAU PLISS PLISS', 'https://res.cloudinary.com/dxffgd86l/image/upload/v1782284999/sewain/47bec7c5-da7a-49ac-b4ab-d265ea066a4f.jpg', NULL),
(13, 36, 'approved', '2026-06-24 15:59:29', 'ytyghghggh', 'https://res.cloudinary.com/dxffgd86l/image/upload/v1782291569/sewain/ac1b929d-95c7-430d-878a-26cff20aec53.png', NULL);
...
(9, 'Kost Sage Green Exclusive Men', 'Jl. Sukabirus No. 12, Dayeuhkolot, Bandung', 1500000, 'Kost', 1, 'Approved', 'None', 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af', 'Kost khusus pria dengan nuansa minimalis modern dekat dengan gerbang belakang kampus. Suasana tenang dan sangat cocok untuk belajar.', 'AC, Wi-Fi / Internet, Kamar Mandi Dalam, Kasur / Bed, Lemari Pakaian, Parkir Mobil / Motor, Keamanan / CCTV', 1, 'Pria', 'Deluxe Room', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
...
(40, 'TEST', 'BOJONGSANTOS', 200000, 'Rumah', 1, 'Pending', 'None', 'https://res.cloudinary.com/dxffgd86l/image/upload/v1782291679/sewain/2678a986-b72a-47bf-b356-9032559d1bd7.png,https://res.cloudinary.com/dxffgd86l/image/upload/v1782291688/sewain/b85b1b3e-756e-4638-a160-503c7cc9d0ab.png', 'TEST', 'AC, Wi-Fi / Internet, Kamar Mandi Dalam', 36, NULL, NULL, 3, 200, NULL, NULL, NULL, NULL, NULL, 0, NULL);
...
(10, 35, 25, 'Gambar Tidak Sesuai', 'Saya ngecek ke lokasi, ternyata fotonya ngambil dari Google! Tolong Admin segera ditindaklanjuti!', 'Resolved', '2026-06-21 14:09:27'),
(16, 9, 36, 'Lainnya', 'Palsu ini jelek banget, saya cek ga ada', 'Resolved', '2026-06-24 08:54:56');
...
(25, 'MBG Wowo', 'mbg@gmail.com', '10000:OvOaMkOexV6k/Xt35t78LA==:D5hPlCjQqyATPELdwqv9l4cm6/YHEJYZDh5ovRJ4ifY=', '0823456789', 'owner', 'Active'),
...
(35, 'adriananispratama', 'vfxgewgr@emailkp.com', '10000:oaXsHUrLnwIvgH5v7s/iFA==:Avoe6rJZubZRxuD7sN+7sS4zHyaOBxPadAyGjb82ZcI=', '088086400', 'owner', 'Active'),
(36, 'Bayu', 'bayu@gmail.com', '10000:mw30FmBp52bsqiCVVVxN2A==:vnbYdizbR/tWGsUlN0WVGha4WMWdOqI+Yni3BuFFU24=', '081212121212', 'owner', 'Active');
...
--
ALTER TABLE `flags`
  MODIFY `flagId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `properties`
  MODIFY `propertyId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

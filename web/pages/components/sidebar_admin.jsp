...
<aside class="admin-sidebar-floating">
    ...
    <div class="sidebar-footer">
        <div class="user-profile-sidebar" style="display: flex; align-items: center; gap: 10px; padding: 12px; background-color: var(--bg-soft); border-radius: 14px;">
            <div class="avatar-circle" style="width: 38px; height: 38px; background-color: #FFFFFF; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: var(--primary-dark); font-size: 1.1rem; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
                <i class="fa-solid fa-user-shield"></i>
            </div>
            <div class="user-info-text" style="display: flex; flex-direction: column;">
                <span style="font-weight: 700; font-size: 0.85rem; color: var(--text-main);"><%= adminUser.getName() %></span>
                <span style="font-size: 0.7rem; color: var(--text-muted); font-weight: 600;">Administrator</span>
            </div>
        </div>
